...
//FOR STATIC SPRITES ONLY .. LIKE Player/Enemies/NPCs
//facing North
...
//update depth WITH LOWERED Z WHEN ON TOP OF OBJECT/PLATFORM . 
//IF WE DONT DO THIS, HALF CLIPPING WILL SOMETIMES OCCUR  
depth = z_axis - z -1;
